# This script implements the TRF encoding and decoding pipeline using raw acoustic features for one subject across all 5 frequency bands
...
# All 5 features
FEATURE_NAMES = ['envelope', 'onsets', 'pitch', 'centroid', 'mel']
    ...
    for feat_idx, feat in enumerate(FEATURE_NAMES):
        ...
        try:
            ...
            for trial_num in range(events.n_cases):
                ...
                trial_rs.append(float(r.mean()) if hasattr(r, 'dims') and r.dims else float(r)) # mel has frequency
